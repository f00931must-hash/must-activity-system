...
## v3.0.1
- 檔案管理容量改為透過 GitHub API 讀取檔案大小，需先設定 GitHub Token。
- 檔案刪除會先嘗試刪除 GitHub 實體檔案，再移除系統連結。
- 檔案清單新增容量與 GitHub 路徑欄位，方便確認是否刪對檔案。

## v3.0.2
- 檔案管理容量改用 GitHub Repository API 直接讀取 repo size。
- 顯示已使用容量 / 1GB，以及估算剩餘容量。
- 舊檔案即使沒有逐檔 size，也能顯示整體 GitHub 用量。
